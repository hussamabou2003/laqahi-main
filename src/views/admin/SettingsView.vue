...
<template>
  <AdminLayout>
    ...
    <!-- النسخ الاحتياطي -->
    <section v-if="activeTab === 'backup'" class="card box-pad backup-section">
      <h2 class="panel__title">النسخ الاحتياطي</h2>
      <p class="panel__desc">سحب نسخ احتياطية لقاعدة بيانات النظام للاحتفاظ بها أو نقلها.</p>

      <div class="backup-container">
        <section class="card backup-card" style="box-shadow: none; border: 1px solid var(--color-border);">
